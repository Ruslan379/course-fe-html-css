...
document.addEventListener('DOMContentLoaded', () => {
    ...
    button1.addEventListener('click', () => {
        if (button1.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/01-fe4-js_14.js'); //!
        } else {
    ...
    button2.addEventListener('click', () => {
        if (button2.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/02-fe4-js_14.js'); //!
        } else {
    ...
    button3.addEventListener('click', () => {
        if (button3.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/03-fe4-js_14.js'); //!
        } else {
    ...
    button4.addEventListener('click', () => {
        if (button4.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/04-fe4-js_14.js'); //!
        } else {
    ...
    button5.addEventListener('click', () => {
        if (button5.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/05-fe4-js_14.js'); //!
        } else {
    ...
    button6.addEventListener('click', () => {
        if (button6.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/06-fe4-js_14.js'); //!
        } else {
    ...
    //         loadAndExecuteScript('./js/07-fe4-js_14.js'); //!
    //     } else {
    ...
    //         loadAndExecuteScript('./js/08-fe4-js_14.js'); //!
    //     } else {
