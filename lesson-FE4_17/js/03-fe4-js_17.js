...
//? ✳️ Щоб знати, коли закінчаться елементи в колекції
//? і вивести про це повідомлення користувачу,
//? бекенд у кожній відповіді повертає не тільки масив елементів,
//? але й метадані про доступну кількість груп («сторінок»),
//? що залежить від значення параметра per_page,
//? або просто загальну кількість елементів в колекції,
//? у такому разі, обчислення кількості груп лягає
//? на плечі фронтенд розробника.
//? ☹️ На жаль, JSONPlaceholder API не реалізує цей функціонал.
console.log("----------------------------------------------------------------------------------------------------------");
