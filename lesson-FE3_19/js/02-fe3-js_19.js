...
//? 🔸 event.target - елемент, у якому безпосередньо сталася подія.
//? 🔸 event.currentTarget - елемент, на якому висить обробник події,
//?    (елемент, на якому спрацьовує обробник події).
