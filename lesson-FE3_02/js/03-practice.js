...
// 1
// Створіть змінні a1, a2, a3, a4, a5 . За допомогою математичних операторів, знайдіть значення виразів: 5 + 3; 5 - 3; 5 * 3; 5/3, помістивши результат кожного виразу в змінну. Наприклад, let a1 = 5 + 3. Вивести в консоль всі змінні по черзі.
const a1 = 5 + 3;
const a2 = 5 - 3;
const a3 = 5 * 3;
const a4 = 5 / 3;
...
// Напишіть скрипт, який знаходить об'єм циліндра висотою 10м і діаметром основи 4м , результат та дані повинні зберігатися в змінних.
