...
document.addEventListener('DOMContentLoaded', () => {
    ...
    button1.addEventListener('click', () => {
        if (button1.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/01-fe3-js_04.js'); //!
        } else {
    ...
    button2.addEventListener('click', () => {
        if (button2.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/02-fe3-js_04.js'); //!
        } else {
    ...
    button3.addEventListener('click', () => {
        if (button3.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/03-fe3-js_04.js'); //!
        } else {
    ...
    button4.addEventListener('click', () => {
        if (button4.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/04-fe3-js_04.js'); //!
        } else {
    ...
    //         loadAndExecuteScript('./js/05-fe3-js_04.js'); //!
    //     } else {
    ...
    //         loadAndExecuteScript('./js/06-fe3-js_04.js'); //!
    //     } else {
    ...
    //         loadAndExecuteScript('./js/07-fe3-js_04.js'); //!
    //     } else {
