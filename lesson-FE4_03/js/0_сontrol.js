...
document.addEventListener('DOMContentLoaded', () => {
    ...
    button1.addEventListener('click', () => {
        if (button1.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/01-what-is-string.js');
        } else {
    ...
    button2.addEventListener('click', () => {
        if (button2.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/02-concatenation-strings.js');
        } else {
    ...
    button3.addEventListener('click', () => {
        if (button3.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/03-properties-methods-strings.js');
        } else {
    ...
    button4.addEventListener('click', () => {
        if (button4.textContent === 'Off') {
            ...
            loadAndExecuteScript('./js/04-template-strings-interpolation.js');
        } else {
    ...
    //         loadAndExecuteScript('./js/06-floating-point-numbers.js');
    //     } else {
    ...
    //         loadAndExecuteScript('./js/07-math-obj.js');
    //     } else {
